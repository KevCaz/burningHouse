...
figure1a <- function(time, CC_p, PB_p, col1 = "#594023", col2 = "#9eb844") {
    ...
    points(seqt - 0.14, CC_p, type = "h", lwd = 6, col = col1)
    points(seqt + 0.14, PB_p, type = "h", lwd = 6, col = col2)
    
    ##-- axes and labels
    axis(4, at = seq(0, 25, 5), labels = F, lwd = cex_mt, lwd.ticks = 0)
    ...
    barplot(c(sum(CC_p), sum(PB_p)), col = c(col1, col2), width = 0.75, space = 0.4, 
