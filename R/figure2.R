...
figure2 <- function(pts, newsPapers, col1 = "#594023", col2 = "#9eb844") {
    ...
    polygon(x = c(as.Date("1990-01-15"), as.Date(newsPapers$month[1:323]), as.Date("2016-12-15")), 
        y = c(0, newsPapers$CC[1:323], 0), col = paste0(col1, "CC"), border = col1)
    polygon(x = c(as.Date("1990-01-15"), as.Date(newsPapers$month[1:323]), as.Date("2016-12-15")), 
        y = c(0, newsPapers$BD[1:323], 0), col = paste0(col2, "CC"), border = col2)
